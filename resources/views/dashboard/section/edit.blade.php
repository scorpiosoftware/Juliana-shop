<x-app-layout>
    ...
    <div class="text-2xl py-4 font-bold underline text-gray-900 dark:text-white">Store Section</div>
       <!-- Breadcrumb -->
   ...
   {{-- End Breadcrumb  --}}
    ...
    <form class="pt-4" action="{{ route('storeSections.update',$record->id) }}" enctype="multipart/form-data" method="POST">
        @csrf
        @method('PUT')

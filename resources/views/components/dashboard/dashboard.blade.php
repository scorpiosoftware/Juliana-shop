                ...
                <ul id="dropdown-ecommerce" @if (Route::currentRouteName() == 'product.index' ||
                    ...
                    <li>
                        <a href="{{ route('storeSections.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Store
                            Sections</a>
                    </li>
                    <li>
                        <a href="{{ route('branch.index') }}"
                            class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Branch</a>
                    </li>
                    <li>

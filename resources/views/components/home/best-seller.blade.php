<div class="pt-4 max-w-screen-xl mx-auto  rounded-md p-4 shadow-xl transform transition-all duration-300 hover:scale-105 hover:shadow-2xl">
    ...
    <div class="relative w-full max-w-screen-xl mx-auto group">
        <div id="scrollContainer-{{ $bestSeller[0]->categories()->first()->id }}" 
